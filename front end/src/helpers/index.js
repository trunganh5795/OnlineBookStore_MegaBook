...
const calTotalOrderFee = (order) => {
  ...
  let total = order.reduce((total, item, index) => total += item.quantity * item.product.price, 0)
  return total;
};
const getDiscountVoucher = (carts, voucher, voucherList, message, selectedVoucher) => {
