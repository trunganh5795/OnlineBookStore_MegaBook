...
const staffApis = {
    ...
    getOrderByStatus: (start_date, end_date, paymentType = null, status, page, perPage = 10, filters = null, search = "", option = 999) => {
        const url = STAFF_API_ENDPOINT + '/getorderbystatus';
        return axiosClient.get(url, { params: { start_date, end_date, paymentType, status, page, perPage, filters, search, option } });
    },
