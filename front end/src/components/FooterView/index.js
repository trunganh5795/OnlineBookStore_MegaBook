    ...
    <div className="container-fluid bg-white footer p-lr-0" id="footer">
      ...
      <div className="footer-contact p-tb-16">
        ...
        <div className='p-lr-10 w-100 container' >
          <p style={{color:'red'}}>These product pictures are used for school project purpose only. Any copyright issues, feel free and send me feedback by clicking on button which at bottom right of page. I will delete it immediately.</p>
        </div>
      </div>
    </div>
  );
