            ...
            tooltip: {
                callbacks: {
                    label: function (tooltipItem, data) {
                        ...
                        let total = dataset.data.reduce((total, item) => total += item, 0)
                        return label + ": " + (parsed / total * 100).toLocaleString("en", { useGrouping: false, minimumFractionDigits: 1 }).slice(0, 4) + '%, ' + 'Số lượng: ' + parsed;
                    }
                }
            }
        },
