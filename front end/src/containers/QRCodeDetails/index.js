...
import { Button, Col, Rate, Row, Tag, Tooltip as TooltipAntd } from 'antd'
...
export default function QRcodeDetails() {
    ...
    const avgRate = useMemo(() => bookDetail.total_rate ? bookDetail.stars / bookDetail.total_rate : 0, [bookDetail])
    useEffect(() => {
                ...
                {bookDetail ? (
                    <>
                            ...
                            >
                                <ul>
                                    <li >
                                        ...
                                        <Rate disabled defaultValue={avgRate}
                                            tooltips={desc}
                                            emptyIcon={
                                            ...
                                            className="m-r-10"
                                        />
                                        <span>{avgRate.toLocaleString("en", { useGrouping: false, minimumFractionDigits: 1 }).slice(0, 3)}</span>
                                    </li>
                                    <li >
                        ...
                        <Col span={24}>
                            ...
                            <LineChart bookId={id} options={constants.LINE_CHART_OPTION_QRCODE_PAGE} />
                        </Col>
