    ...
    return (
        <div className="bg-white p-lr-12 bor-rad-8 p-tb-30">
            <div className='pos-relative'>
                <h2>Tổng đơn hàng: {responeData.order.reduce((total, ele, index) => total += ele, 0)}</h2>
                <h2>Tổng đơn hàng: {helpers.formatProductPrice(responeData.total.reduce((total, ele, index) => total += ele, 0))}</h2>
