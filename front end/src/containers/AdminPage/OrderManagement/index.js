...
export default function OrderManagement() {
                ...
                <>
                    <div>
                        <Button
                            type="danger"
                            className=' w-86px'
                            onClick={() => updateOrderStatus(records.id, "6", records.status)}>
                            Hủy đơn
                        </Button>
                    </div>
                ...
                <>
                    <div>
                        <Button
                            type="primary"
                            className=' w-86px'
                            onClick={() => updateOrderStatus(records.id, "3", records.status)}
                        >
                            Xác nhận
                        </Button>
                    </div>
    ...
    useEffect(() => {
        isSubscribe = true;
        if (!isOpenRangeTime) {
            if (!(rangeTimeTemp[0].format('DD-MM-YYYY') === rangeTime[0].format('DD-MM-YYYY') && rangeTimeTemp[1].format('DD-MM-YYYY') === rangeTime[1].format('DD-MM-YYYY'))) {
                ...
                options={[
                    {
                        label: (
                            <div style={{ padding: 8 }}>
                                ...
                                <div>Tất cả</div>
                                <p className='oder-value'>({CountAndGroupOrder.length ? CountAndGroupOrder.reduce((total, item) => total += item, 0) : '--'})</p>
                            </div>
                        ),
                        value: 0,
                    },
                    {
                        label: (
                            <div style={{ padding: 8 }}>
                                ...
                                <p>Chờ thanh toán</p>
                                <p className='oder-value'>({CountAndGroupOrder[0] ? CountAndGroupOrder[0] : '--'})</p>
                            </div>
                        ),
                        value: 1,
                    },
                    {
                        label: (
                            <div style={{ padding: 8 }}>
                                ...
                                <p>Chờ xác nhận</p>
                                <p className='oder-value'>({CountAndGroupOrder[1] ? CountAndGroupOrder[1] : '--'})</p>
                            </div>
                        ),
                        value: 2,
                    },
                    {
                        label: (
                            <div style={{ padding: 8 }}>
                                ...
                                <p>Chờ lấy hàng</p>
                                <p className='oder-value'>({CountAndGroupOrder[2] ? CountAndGroupOrder[2] : '--'})</p>
                            </div>
                        ),
                        value: 3,
                    },
                    {
                        label: (
                            <div style={{ padding: 8 }}>
                                ...
                                <p className='oder-value'>({CountAndGroupOrder[3] ? CountAndGroupOrder[3] : '--'})</p>
                            </div>
                        ),
                        value: 4,
                    },
                    {
                        label: (
                            <div style={{ padding: 8 }}>
                                ...
                                <div>Hoàn thành</div>
                                <p className='oder-value'>({CountAndGroupOrder[4] ? CountAndGroupOrder[4] : '--'})</p>
                            </div>
                        ),
                        value: 5,
                    },
                    {
                        label: (
                            <div style={{ padding: 8 }}>
                                ...
                                <div>Đơn hủy</div>
                                <p className='oder-value'>({CountAndGroupOrder[5] ? CountAndGroupOrder[5] : '--'})</p>
                            </div>
                        ),
                        value: 6,
                    }
                ...
                <Row gutter={[16, 16]}>
                    ...
                    <Col flex="auto">
                        <RangePicker
                            ...
                            okText="OK"
                            onCalendarChange={(rangeInMoment, rangeInString) => rangeTimeTemp = rangeInMoment}
