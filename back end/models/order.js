...
module.exports = (sequelize, DataTypes) => {
    class Order extends Model {
         ...
         */
        static associate({ Order_detail, ShippingAddress, User, Province, Predict_cancellation }) {
            // define association here
            this.hasMany(Order_detail, { foreignKey: 'order_id', as: 'order_detail' })
            ...
            this.hasOne(Predict_cancellation, { sourceKey: 'id', foreignKey: 'order_id', as: 'ratio' })
