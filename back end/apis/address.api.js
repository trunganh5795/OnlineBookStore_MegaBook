...
addressApi.get('/delivery', passportAuth.jwtAuthentication, addressController.getShippingAddressList);
// api: Thêm địa chỉ nhận hàng
addressApi.post('/delivery', passportAuth.jwtAuthentication, addressController.addNewShippingAddress);

// // api: Xoá 1 địa chỉ nhận hàng
addressApi.delete('/delivery', passportAuth.jwtAuthentication, addressController.delAddDeliveryAddress);

// api: cài mặc định 1 địa chỉ nhận hàng
addressApi.put('/delivery', passportAuth.jwtAuthentication, addressController.putSetDefaultDeliveryAddress);
