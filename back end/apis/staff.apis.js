...
staffApi.get('/countoderbystatus', passportAuth.jwtAuthentication, staffController.countOrderByStatus);
staffApi.get('/getorderbystatus', passportAuth.jwtAuthentication, staffController.getOrderList);
staffApi.put('/confimorderbulk', passportAuth.jwtAuthentication, staffController.comfirmOrderBulk);
